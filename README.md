...
| #027 | `drivers/misc/ibmasm/module.c`                   | [Page fault via undersized PCI BAR 0 in ibmasm](https://github.com/Wmingyu/DevGen-results/blob/main/details/Page%20fault%20via%20undersized%20PCI%20BAR%200%20in%20ibmasm.md) | ✅ **Patch Accepted**                                         |
...
| #030 | `kernel/module/main.c`                           | [UAF and GPF in idempotent_init_module()](https://github.com/Wmingyu/DevGen-results/blob/main/details/UAF%20and%20GPF%20in%20idempotent_init_module().md) | 🆕 **Bug Reported**<br/>🛠️ **Patch Sent**                      |
